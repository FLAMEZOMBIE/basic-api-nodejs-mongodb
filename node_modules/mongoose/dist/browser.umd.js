 ...
 * Module exports.
 */
t.exports=function(t,e,r){var n=new g;if(n[p]={},n[v]=void 0,Array.isArray(t)&&(t instanceof g&&t[y]===e&&t[d]===r&&(n[p]=Object.assign({},t[p])),t.forEach(function(t){m.call(n,t)})),n[y]=e,r&&r instanceof s)for(n[d]=r,n[v]=r.schema.path(e);null!=n&&null!=n[v]&&n[v].$isMongooseArray&&!n[v].$isMongooseDocumentArray;)n[v]=n[v].casterConstructor;return n}}).call(this,r(1).Buffer)},function(t,e,r){"use strict";
/*!
 * ignore
 ...
 * ignore
 */
b.prototype.clone=function(){var t=Object.assign({},this.options),e=new this.constructor(this.path,this.caster,t,this.schemaOptions);return e.validators=this.validators.slice(),e},b.prototype.castForQuery=function(t,e){var r=this,n=void 0,i=void 0;if(2===arguments.length){if(!(n=this.$conditionalHandlers[t]))throw new Error("Can't use "+t+" with Array.");i=n.call(this,e)}else{i=t;var o=this.casterConstructor;if(i&&o.discriminators&&o.schema&&o.schema.options&&o.schema.options.discriminatorKey)if("string"==typeof i[o.schema.options.discriminatorKey]&&o.discriminators[i[o.schema.options.discriminatorKey]])o=o.discriminators[i[o.schema.options.discriminatorKey]];else{var s=_(o,i[o.schema.options.discriminatorKey]);s&&(o=s)}var a=this.casterConstructor.prototype,u=a&&(a.castForQuery||a.cast);!u&&o.castForQuery&&(u=o.castForQuery);var c=this.caster;Array.isArray(i)?(this.setters.reverse().forEach(function(t){i=t.call(r,i,r)}),i=i.map(function(t){return d.isObject(t)&&t.$elemMatch?t:u?t=u.call(c,t):null!=t?t=new o(t):t})):u?i=u.call(c,i):null!=i&&(i=new o(i))}return i};var w=b.prototype.$conditionalHandlers={};w.$all=function(t){return Array.isArray(t)||(t=[t]),t=t.map(function(t){if(d.isObject(t)){var e={};return e[this.path]=t,l(this.casterConstructor.schema,e)[this.path]}return t},this),this.castForQuery(t)},w.$options=String,w.$elemMatch=function(t){for(var e=Object.keys(t),r=e.length,n=0;n<r;++n){var i=e[n],o=t[i];h(i)&&null!=o&&(t[i]=this.castForQuery(i,o))}var s=f(this,"casterConstructor.schema.options.discriminatorKey"),a=f(this,"casterConstructor.schema.discriminators",{});return null!=s&&null!=t[s]&&null!=a[t[s]]?l(a[t[s]],t):l(this.casterConstructor.schema,t)},w.$geoIntersects=v.cast$geoIntersects,w.$or=w.$and=function(t){if(!Array.isArray(t))throw new TypeError("conditional $or/$and require array");for(var e=[],r=0;r<t.length;++r)e.push(l(this.casterConstructor.schema,t[r]));return e},w.$near=w.$nearSphere=v.cast$near,w.$within=w.$geoWithin=v.cast$within,w.$size=w.$minDistance=w.$maxDistance=y,w.$exists=n,w.$type=i,w.$eq=w.$gt=w.$gte=w.$lt=w.$lte=w.$ne=w.$regex=b.prototype.castForQuery,w.$nin=a.prototype.$conditionalHandlers.$nin,w.$in=a.prototype.$conditionalHandlers.$in,
/*!
 * Module exports.
 */
